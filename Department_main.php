...
$check = "select count(`reg_no`) from `no_dues`.`users`";
    ...
    <div class="content">
        <table style="margin: 0 auto;">
            ...
            <tbody style="text-align: center; font-weight: bolder; background-color: #f2f2f2; color: #000000;">
                <?php
                $i1 = 0;
                $sql2 = "select * from `no_dues`.`users` order by `reg_no`";
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $rows6['reg_no']; ?></td>
                        <td><?php echo $rows6['mail']; ?></td>
                        <td><?php echo $rows6['dept']; ?></td>
                        <td><?php echo $rows6['section']; ?></td>
                        <td><button onclick="<?php
                                                if ($dept == 1) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_medicare` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1); 
                                                }
                                                else if ($dept == 2) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_library` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 3) {
                                                    $sql = "UPDATE `no_dues`.`users` SET `ap_ams` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 4) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_sports` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 5) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_IT` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 6) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_hostel` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 7) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_mess` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 8) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_finance` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 9) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_academics` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                else if ($dept == 10) {
                                                    $sql1 = "UPDATE `no_dues`.`users` SET `ap_dept` = '1' WHERE `reg_no` = $r";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                }
                                                ?>">Approve</button>
                        </td>
